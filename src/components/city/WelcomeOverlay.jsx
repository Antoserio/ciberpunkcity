        ...
        >
          <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:gap-8">
            <div className="rounded-[28px] border border-white/10 bg-black/20 p-6 sm:p-8 lg:p-10">
              <p className="mb-4 font-rajdhani text-[11px] uppercase tracking-[0.48em] text-cyan-300/75">Inmersive Portfolio Experience</p>
              <h1 className="max-w-3xl bg-gradient-to-r from-cyan-200 via-white to-fuchsia-300 bg-clip-text font-orbitron text-4xl font-black uppercase leading-[0.95] tracking-[0.08em] text-transparent sm:text-6xl lg:text-7xl">
                Nexus 360
              </h1>
            ...
            <div className="grid gap-4">
              ...
              <div className="rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-5 sm:p-6">
                ...
                <div className="space-y-3">
                  {[
                    ['Avatar XR', 'Metahuman, realtime y presencia digital'],
                    ['Dance Mapping', 'Escena visual, vídeo e impacto inmersivo'],
                    ['Studio 360', 'Producción para contenido XR y 360º'],
                    ['Arcade Nexus', 'Interacción lúdica dentro del recorrido'],
                  ].map(([title, desc]) => (
